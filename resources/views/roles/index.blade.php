...
<div class="max-w-7xl mx-auto py-6">
    <h1 class="text-2xl font-bold text-gray-700 mb-6">{{ __('Role Management') }}</h1>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="flex justify-end mb-4">
                        <a href="{{ route('roles.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Add New Role</a>
                    </div>
