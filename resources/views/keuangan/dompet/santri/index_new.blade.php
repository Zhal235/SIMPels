            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                ...
                <div class="p-6">
                    <div x-show="!selectedSantri" class="text-center py-16">
                        ...
                        <p class="text-gray-500">Pilih santri dari sidebar untuk melihat detail dompet digital dan transaksi</p>
                    </div>
    ...
    return {
        ...
        async loadWalletData(santriId) {
            try {
                ...
                this.walletBalance = Math.floor(Math.random() * 1000000) + 50000;
                this.walletNumber = 'DMP' + santriId.toString().padStart(6, '0');
                this.walletStatus = Math.random() > 0.1 ? 'active' : 'inactive';
                ...
                this.transactions = [
                    ...
                    },
                    {
                        ...
                        amount: 25000,
                        balance: this.walletBalance - 25000,
                        date: '2024-12-08'
                    },
                    {
                        id: 3,
                        ...
                        description: 'Top Up Saldo',
                        amount: 50000,
                        balance: this.walletBalance - 25000 - 50000,
                        date: '2024-12-07'
                    }
                ];
            } catch (error) {
        ...
        async processTopup() {
            try {
                ...
                console.log('Processing top up:', this.topupAmount);
                
                // Update balance
                this.walletBalance += parseFloat(this.topupAmount);
        ...
        async processWithdraw() {
            try {
                // Mock processing - replace with actual API call
                console.log('Processing withdraw:', this.withdrawAmount);
                
                // Update balance
                this.walletBalance -= parseFloat(this.withdrawAmount);
