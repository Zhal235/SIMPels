...
<div class="max-w-6xl mx-auto py-6">
    <div class="flex items-center justify-between mb-4">
        ...
        <div class="flex gap-2">
            <a href="{{ route('tabungan-santri.create') }}"
               class="bg-green-600 text-white px-4 py-2 rounded shadow hover:bg-green-700 flex items-center gap-2">
                <span class="text-xl font-bold">+</span> Tambah Tabungan
            </a>
            <a href="{{ route('tabungan-santri.import') }}"
        ...
        <table class="min-w-full text-sm text-left border">
            <thead class="bg-gray-100 text-xs font-semibold uppercase">
                <tr>
                    ...
                    <th class="p-3">Total Saldo</th>
                    <th class="p-3">Aksi</th>
                </tr>
            </thead>
            <tbody>
                {{-- Data tabungan santri akan ditampilkan di sini --}}
            </tbody>
        </table>
    </div>
</div>
