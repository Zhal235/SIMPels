...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
        <div>
            <h1 class="text-3xl font-bold text-gray-900 flex items-center gap-2">
                ...
                Tunggakan Santri Alumni
            </h1>
            <p class="text-gray-600 mt-2">Daftar tunggakan tagihan santri yang telah menjadi alumni tahun ajaran {{ $tahunAjaran->nama_tahun_ajaran }}.</p>
        </div>
        <div class="flex flex-col sm:flex-row gap-2 mt-4 sm:mt-0">
            <a href="{{ route('keuangan.tunggakan.export-excel') }}?tipe=alumni" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg font-medium transition-colors duration-200 flex items-center">
                <span class="material-icons-outlined text-sm mr-2">file_download</span>
                Export Excel
            </a>
            <a href="{{ route('keuangan.tunggakan.print') }}?tipe=alumni" target="_blank" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg font-medium transition-colors duration-200 flex items-center">
    ...
    <div class="bg-white rounded-lg shadow mb-6">
        <div class="flex flex-wrap">
            ...
            <a href="{{ route('keuangan.tunggakan.santri-mutasi') }}" class="px-4 py-3 border-b-2 border-transparent hover:border-gray-300 text-gray-700">
                Mutasi
            </a>
            <a href="{{ route('keuangan.tunggakan.santri-alumni') }}" class="px-4 py-3 border-b-2 border-purple-600 text-purple-600 font-medium">
                Alumni
            </a>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                @php
                    ...
                    $tanggalKelulusan = $santri->tanggal_kelulusan ? \Carbon\Carbon::parse($santri->tanggal_kelulusan)->format('d-m-Y') : '-';
                    $kontak = $santri->hp_ayah ?: ($santri->hp_ibu ?: '-');
                @endphp
        ...
        <div class="p-8 text-center">
            <div class="text-gray-500 text-lg mb-4">Tidak ada data tunggakan untuk santri alumni.</div>
            <div class="text-gray-400">Semua santri alumni telah melunasi tagihan mereka.</div>
        </div>
        @endif
    </div>
</div>
