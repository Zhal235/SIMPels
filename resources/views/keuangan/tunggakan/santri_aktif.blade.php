...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
        <div>
            <h1 class="text-3xl font-bold text-gray-900 flex items-center gap-2">
                <span class="material-icons-outlined text-blue-600">payment</span>
                Tunggakan Santri Aktif
            </h1>
            <p class="text-gray-600 mt-2">Daftar tunggakan tagihan santri yang masih aktif di pesantren tahun ajaran {{ $tahunAjaran->nama_tahun_ajaran }}.</p>
        </div>
        <div class="flex flex-col sm:flex-row gap-2 mt-4 sm:mt-0">
            <a href="{{ route('keuangan.tunggakan.export-excel') }}" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg font-medium transition-colors duration-200 flex items-center">
                <span class="material-icons-outlined text-sm mr-2">file_download</span>
                Export Excel
            </a>
            <a href="{{ route('keuangan.tunggakan.print') }}" target="_blank" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg font-medium transition-colors duration-200 flex items-center">
    ...
    <div class="bg-white rounded-lg shadow mb-6">
        <div class="flex flex-wrap">
            <a href="{{ route('keuangan.tunggakan.santri-aktif') }}" class="px-4 py-3 border-b-2 border-blue-600 text-blue-600 font-medium">
                Santri Aktif
            </a>
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        ...
        <div class="p-8 text-center">
            <div class="text-gray-500 text-lg mb-4">Tidak ada data tunggakan untuk santri aktif.</div>
            <div class="text-gray-400">Semua santri aktif telah melunasi tagihan mereka.</div>
        </div>
        @endif
    </div>
</div>
