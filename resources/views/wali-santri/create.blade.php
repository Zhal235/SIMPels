        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                <div class="flex justify-between items-center mb-6">
                    <h2 class="text-2xl font-semibold text-gray-800">Tambah Wali Santri</h2>
                ...
                <form action="{{ route('wali-santri.store') }}" method="POST" class="space-y-6">
                    @csrf
                    ...
                    <div>
                        ...
                        <div class="bg-gray-50 p-4 rounded-md max-h-64 overflow-y-auto">
                            @if($santris->count() > 0)
                                ...
                                @endforeach
                            @else
                                <p class="text-gray-500">Tidak ada santri yang tersedia</p>
                            @endif
                        </div>
                        @error('santri_ids')
                            <span class="text-red-500 text-sm">{{ $message }}</span>
